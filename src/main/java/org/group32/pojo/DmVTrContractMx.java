...
@Data
public class DmVTrContractMx extends POJO{
    ...
    private double loanPert;
    private long termYear;
    private long termMth;
    ...
    private double dlayBal;
    private double dullBal;
